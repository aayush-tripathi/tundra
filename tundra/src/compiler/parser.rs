...
impl ParseRule {
    pub const fn prefix(prefix: ParserFunction, precedence: Precedence) -> Self {
        ParseRule { prefix: Some(prefix), infix: None, precedence }
    }
    pub const fn infix(infix: ParserFunction, precedence: Precedence) -> Self {
        ParseRule { prefix: None, infix: Some(infix), precedence }
    }
    pub const fn both(prefix: ParserFunction, infix: ParserFunction, precedence: Precedence) -> Self {
        ParseRule { prefix: Some(prefix), infix: Some(infix), precedence }
    }
